...
impl RouterState {
    ...
    pub fn apply_command(&mut self, command: RouterCommand) -> Result<()> {
        match command {
            ...
            RouterCommand::CommitSourceOffset {
                source_id,
                partition,
                offset,
            } => {
            ...
            RouterCommand::AdvanceWatermark {
                source_id,
                partition,
                position,
                event_time,
            ...
            RouterCommand::SaveServiceCheckpoint {
                service_id,
                checkpoint_id,
                data,
                source_offsets,
            ...
            RouterCommand::AssignPartitions {
                group_id,
                assignments,
                generation,
            } => {
            ...
            RouterCommand::CommitGroupOffset {
                group_id,
                source_id,
                partition,
                offset,
