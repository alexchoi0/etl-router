...
This crate provides a complete Raft consensus implementation tailored for ETL Router. It handles leader election, log replication, and state machine application to ensure consistent state across all cluster nodes.
...
```rust
use etl_raft::{RaftNode, RaftConfig, RouterStateMachine};
