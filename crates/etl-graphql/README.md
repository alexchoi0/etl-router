...
GraphQL API for the ETL Router dashboard.

## Overview

This crate provides a GraphQL API for querying and managing ETL Router resources. It powers the web dashboard and can be used by external tools.
...
```rust
use etl_graphql::{GraphQLServer, create_schema};
