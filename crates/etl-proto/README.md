...
This crate contains all `.proto` files defining the gRPC services and message types used throughout ETL Router. The Rust code is generated at build time using `tonic-build`.
...
```rust
use etl_proto::common::{Record, RecordBatch};
use etl_proto::transform::transform_service_client::TransformServiceClient;
use etl_proto::sink::sink_service_server::SinkServiceServer;
